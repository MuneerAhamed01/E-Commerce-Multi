...
/// `MaterialApp.router` (driven by `go_router` and `AppTheme`, with a
/// role-aware side nav shell) in Phase 5 (Routing Foundation) and Phase 21
/// (Admin Foundation) - see docs/03_DEVELOPMENT_PHASES.md.
class AppWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'White Label Commerce Platform - Admin',
